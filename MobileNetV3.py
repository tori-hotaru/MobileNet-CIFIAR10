...
class SEModule(nn.Module):
    ...
    def forward(self, x):
        ...
        return x * y.expand_as(x)  # 通过y对x的每个通道进行加权，增强了网络对重要特征的关注。
...
class MobileNetV3(nn.Module):
    def __init__(self, n_class=1000, input_size=224, dropout=0.8, mode='large', width_mult=1.0):
        ...
        # make channel number divisible by 8, can accelerate the speed of training
...
if __name__ == "__main__":
    # model check
    net = mobilenetv3()
    summary.summary(net, (3, 224, 224), device='cpu')
